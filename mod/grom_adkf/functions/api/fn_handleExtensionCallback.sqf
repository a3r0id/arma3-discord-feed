...
if (count(_data) < 1) exitWith {systemChat "arma3-discord-feed: ExtensionCallback: No data returned from extension!";};
...
_functions set ["simpleFeedEmbed", {
    ...
    systemChat format ["arma3-discord-feed: simpleFeedEmbed: Response: %1", _data];
}];